...
curl -SL https://github.com/abtreece/confd/releases/download/v0.30.0/confd-v0.30.0-darwin-amd64.tar.gz | tar -xz -C /usr/local/bin/

# For Apple Silicon (arm64)
curl -SL https://github.com/abtreece/confd/releases/download/v0.30.0/confd-v0.30.0-darwin-arm64.tar.gz | tar -xz -C /usr/local/bin/
```
...
```bash
# For amd64
curl -SL https://github.com/abtreece/confd/releases/download/v0.30.0/confd-v0.30.0-linux-amd64.tar.gz | tar -xz -C /usr/local/bin/

# For arm64
curl -SL https://github.com/abtreece/confd/releases/download/v0.30.0/confd-v0.30.0-linux-arm64.tar.gz | tar -xz -C /usr/local/bin/
```

Or manually:
```bash
wget https://github.com/abtreece/confd/releases/download/v0.30.0/confd-v0.30.0-linux-amd64.tar.gz
tar -xzf confd-v0.30.0-linux-amd64.tar.gz
